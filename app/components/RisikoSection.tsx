...
export default function RisikoSection({
  ...
  useSectionScrollGate(sectionRef, isAnimPlaying);
  ...
  return (
    <section
      ...
      className="relative min-h-screen w-full overflow-hidden bg-cream px-[6vw] py-[10vh]"
    >
      <div className="flex min-h-[78vh] w-full flex-row flex-nowrap items-start gap-x-[4vw] pt-[4vh]">
