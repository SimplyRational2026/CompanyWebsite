...
export const metadata: Metadata = {
  title: "Datenschutzerklärung | Simply Rational",
};
  ...
  return (
    <LegalPage title="Datenschutzerklärung">
      <p>
        ...
        Geschäftsleitung der Simply Rational GmbH. Eine Nutzung der
        Internetseiten der Simply Rational GmbH ist grundsätzlich ohne jede
      ...
      <p>
        ...
        Übereinstimmung mit den für die Simply Rational GmbH geltenden
      ...
      <p>
        Die Simply Rational GmbH hat als für die Verarbeitung Verantwortlicher
      ...
      <p>
        Die Datenschutzerklärung der Simply Rational GmbH beruht auf den
      ...
      <p>
        ...
        <br />
        Website: www.simplyrational.de
      </p>

      <h2>3. Cookies</h2>
      <p>
        Die Internetseiten der Simply Rational GmbH verwenden Cookies. Cookies
      ...
      <p>
        Durch den Einsatz von Cookies kann die Simply Rational GmbH den Nutzern
      ...
      <p>
        Die Internetseite der Simply Rational GmbH erfasst mit jedem Aufruf der
      ...
      <p>
        ...
        Simply Rational GmbH keine Rückschlüsse auf die betroffene Person. Diese
        ...
        und der Technik unserer Internetseite zu gewährleisten sowie (4) um
        ...
        erhobenen Daten und Informationen werden durch die Simply Rational GmbH
      ...
      <p>
        Die Internetseite der Simply Rational GmbH enthält aufgrund von
        ...
        betroffene Person per E-Mail oder über ein Kontaktformular den Kontakt
        mit dem für die Verarbeitung Verantwortlichen aufnimmt, werden die von
      ...
      <p>
        ...
        Person die Löschung von personenbezogenen Daten, die bei der Simply
        Rational GmbH gespeichert sind, veranlassen möchte, kann sie sich hierzu
        jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
        wenden. Der Mitarbeiter der Simply Rational GmbH wird veranlassen, dass
        dem Löschverlangen unverzüglich nachgekommen wird.
      </p>
      <p>
        Wurden die personenbezogenen Daten von der Simply Rational GmbH
        ...
        verpflichtet, so trifft die Simply Rational GmbH unter Berücksichtigung
        ...
        Simply Rational GmbH wird im Einzelfall das Notwendige veranlassen.
      </p>
      ...
      <p>
        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
        von dem Verantwortlichen die Einschränkung der Verarbeitung zu verlangen,
      ...
      <p>
        ...
        der Simply Rational GmbH gespeichert sind, verlangen möchte, kann sie
        sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
        Verantwortlichen wenden. Der Mitarbeiter der Simply Rational GmbH wird
      ...
      <p>
        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
        die sie betreffenden personenbezogenen Daten, welche durch die betroffene
      ...
      <p>
        ...
        betroffene Person jederzeit an einen Mitarbeiter der Simply Rational
        GmbH wenden.
      </p>
      ...
      <p>
        Die Simply Rational GmbH verarbeitet die personenbezogenen Daten im
      ...
      <p>
        Verarbeitet die Simply Rational GmbH personenbezogene Daten, um
        ...
        Widerspricht die betroffene Person gegenüber der Simply Rational GmbH der
        Verarbeitung für Zwecke der Direktwerbung, so wird die Simply Rational
      ...
      <p>
        ...
        Verarbeitung personenbezogener Daten, die bei der Simply Rational GmbH zu
      ...
      <p>
        ...
        direkt an jeden Mitarbeiter der Simply Rational GmbH oder einen anderen
      ...
      <p>
        ...
        betroffenen Person, trifft die Simply Rational GmbH angemessene
      ...
      <p>
        ...
        sonstigen berechtigten Interessen des für die Verarbeitung
      ...
      <p>
        ...
        beispielsweise die Zugriffszeit, der Ort, von welchem ein Zugriff ausging
        und die Häufigkeit der Besuche unserer Internetseite durch die betroffene
        Person, gespeichert. Bei jedem Besuch unserer Internetseiten werden diese
      ...
      <p>
        ...
        der durch Google Analytics erzeugten, auf eine Nutzung dieser
      ...
      <h2>10. Datenschutzbestimmungen zu Einsatz und Verwendung von LinkedIn</h2>
      <p>
        ...
        Internetseiten der Welt. Betreibergesellschaft von LinkedIn ist die
        LinkedIn Corporation, 2029 Stierlin Court Mountain View, CA 94043, USA.
        Für Datenschutzangelegenheiten außerhalb der USA ist LinkedIn Ireland,
      ...
      <p>
        ...
        an LinkedIn von der betroffenen Person nicht gewollt, kann diese die
      ...
      <h2>11. Datenschutzbestimmungen zu Einsatz und Verwendung von YouTube</h2>
      <p>
        Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite
        ...
        Videos über das Internetportal abrufbar sind. Betreibergesellschaft von
        YouTube ist die Google Ireland Limited, Gordon House, Barrow Street,
      ...
      <p>
        ...
        eine YouTube-Komponente (YouTube-Video) integriert wurde, wird der
      ...
      <p>
        ...
        anklickt oder nicht. Ist eine derartige Übermittlung dieser Informationen
        an YouTube und Google von der betroffenen Person nicht gewollt, kann diese
        die Übermittlung dadurch verhindern, dass sie sich vor einem Aufruf
        unserer Internetseite aus ihrem YouTube-Account ausloggt. Die von YouTube
        ...
        Nutzung personenbezogener Daten durch YouTube und Google.
      </p>
      ...
      <p>
        ...
        Datenschutz GmbH, die Datenschutz-Audit durchführt, in Kooperation mit
        der Medienrechtskanzlei WILDE BEUGER SOLMECKE erstellt.
      </p>
    </LegalPage>
  );
}
